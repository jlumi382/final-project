...
<section class="gallerySection">
    <div class="galleryContainer">
        <div class="big">
            <img src="./images/content/cambugahayBig.jpg">
        </div>
        <div class="wide">
            <img src="./images/content/cambugahayWide.jpg">
        </div>
        <div class="tall">
        ...
        <div class="wide">
            <img src="./images/content/salagdoongWide.jpg">
        </div>
        <div class="big">
            <img src="./images/content/salagdoongBig.jpg">
        </div>
        <div class="wide">
            <img src="./images/content/fishSpaWide.JPG">
        </div>
        <div class="tall">
            <img src="./images/content/fishSpaTall.jpg">
        </div>
        <div class="big">
            <img src="./images/content/fishSpaBig.jpg">
        </div>
        <div class="tall">
            <img src="./images/content/siquijorMap.jpg">
        </div>
        <div class="wide">
            <img src="./images/content/iLoveSiqujor.jpg">
        </div>
    </div>
</section>
</main>
