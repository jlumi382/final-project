...
<main>
    <section class="heroHometownSection">
        <div class="heroHometownContent">
            ...
            <a class="heroHometownButton" href="#secondHometownSection">Get Started</a>
        </div>
    </section>
    <section class="secondHometownSection" id="secondHometownSection">
        <div class="secondHometownContent">
            <h1>Province Highlights</h1>
            <div class="secondHometownImages">
                <div class="provinceHighlightContainer" data-dialog="firstHighlight">
                    <img src="./images/content/cambugahayTall.jpg">
                    <div class="overlayText">
                        <h3>Cambugahay Falls</h3>
                        <p><small>Click to view details</small></p>
                    </div>
                </div>
                <dialog id="firstHighlight">
                    <a class="closeHighlightDialog">Close</a>
                    <h2>Cambugahay Falls</h2>
                    <hr>
                    <p>Cambugahay Falls is an absolutely gorgeous waterfall in Siquijor, Philippines, and it's definitely a must-see! The water is this beautiful shade of turquoise, and it's nestled among some lush, green trees, making it a super chill spot. You can swim around in the refreshing pools, take a swing on a rope for a fun dive, or just lounge by the falls and soak it all in. Whether you're looking to relax or get a little adventurous, Cambugahay Falls has got something for everyone!</p>
                </dialog>
                <div class="provinceHighlightContainer" data-dialog="secondHighlight">
                    <img src="./images/content/salagdoongTall.jpg">
                    <div class="overlayText">
                        <h3>Salagdoong Beach</h3>
                        <p><small>Click to view details</small></p>
                    </div>
                </div>
                <dialog id="secondHighlight">
                    <a class="closeHighlightDialog">Close</a>
                    <h2>Salagdoong Beach</h2>
                    <hr>
                    <p>Salagdoong Beach is an absolute hidden gem in Siquijor, Philippines. With its soft, white sand and stunning turquoise waters, it’s the perfect place to chill out or have some fun. If you’re feeling adventurous, you can try cliff diving into the crystal-clear sea – it’s a total rush! Not into jumping off cliffs? No worries! You can go snorkeling, swim around, or just soak up the sun surrounded by gorgeous greenery. If you're looking for a beautiful spot with plenty of cool things to do, Salagdoong Beach is definitely the place to go!</p>
                </dialog>
                <div class="provinceHighlightContainer" data-dialog="thirdHighlight">
                    <img src="./images/content/fishSpaTall.jpg">
                    <div class="overlayText">
                        <h3>Siquijor Enchanted Balete Tree with Fish Spa</h3>
                        <p><small>Click to view details</small></p>
                    </div>
                </div>
                <dialog id="thirdHighlight">
                    <a class="closeHighlightDialog">Close</a>
                    <h2>Siquijor Enchanted Balete Tree with Fish Spa</h2>
                    <hr>
                    <p>Siquijor Enchanted Tree with Fish Spa is an amazing spot on the mystical island of Siquijor in the Philippines. Imagine an ancient balete tree surrounded by beautiful green foliage. It's not just about the tree, though—there's a natural spring at its base where you can dip your feet and let tiny fish give them a little nibble. It’s a super relaxing experience! Plus, there’s a souvenir shop nearby where you can pick up some unique items, like the famous "Love Potion of Siquijor." It’s a fun little keepsake that captures the island’s enchanting vibe. Overall, it’s a great place to unwind and soak in the beauty and magic of nature and local culture.</p>
                </dialog>
            </div>
        <div>
    </section>
